    ...
    <div class="container-fluid">
                ...
                <div class="">
                    ...
                    <div class="body">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" placeholder="enter here.." id="title" class="form-control" name="title" value="{{ old('title') }}">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 40px;">
                ...
                <div class="body">
                        <a class="btn btn-danger waves-effect m-t-15" href="{{ route('author.post.index') }}">Back</a>
